...
def get_request(url, **kwargs):
    ...
    try:
        if api_key:
            ...
            response = requests.get(url, data=params, headers={'Content-Type': 'application/json'}, 
...
def get_dealers_from_cf(url, **kwargs):
    ...
    if json_result:
        ...
        dealers = json_result["body"]["result"]
...
#create a get_dealer_by_id_from_cf method
def get_dealers_by_id_from_cf(url, dealer_Id):
    results = []
    # Call get_request with a URL parameter
...
def analyze_review_sentiments(dealerreview):
    api_key = "Nu6rreHOTjWJh18OP3I-UfBk23Mh8r7H-8jtz1ZTOig7"
    url = "https://api.us-east.natural-language-understanding.watson.cloud.ibm.com/instances/14fcc58b-5079-4f3c-a995-e7198b210816"
